...
class FemaleChatScreen extends StatefulWidget {
  static const routeName = 'female_chatScreen';
  const FemaleChatScreen({Key? key}) : super(key: key);

  @override
  _FemaleChatScreenState createState() => _FemaleChatScreenState();
}
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                color: AppColors.femaleEarnedColor,
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    Text(
                                      AppTextConst.earned,
                                      style: AppFonts.earnedStyle,
                                    ),
                                    Text(
                                      '300,0000',
                                      style: TextStyle(
                        ...
                        Row(
                          children: [
                            Text(
                              ...
                              style: AppFonts.nickNameStyle.copyWith(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        AppTextConst.recommend,
                                        style: AppFonts.heartFont.copyWith(
                                            fontSize: 13.sp,
                                            color: Colors.black),
                                      ),
                                      Image.asset(
